...
$(function () {
    ...
    $('#btn-send-feedback').on('click', function () {
        ...
        $('#feedbackbox .invalid-feedback').html('');
        $('#feedbackbox .is-invalid').removeClass('is-invalid');
        $.post("/" + appData.country + "/profile/sendfeedback",
            { feedbacktext: $('#feedback_feedbacktext').val(), csrfmiddlewaretoken: csrftoken },
            ...
            if (jqXHR.responseJSON && jqXHR.responseJSON.errors) {
                uncaught = !showFieldErrors("feedback_", jqXHR.responseJSON.errors);
            }
            if (uncaught) {
...
function showFieldErrors(prefix, errors) {
    ...
    for (const field in errors) {
        ...
        if (input) {
            ...
            if (feedbackElement) {
                feedbackElement.html("<strong>" + errors[field].join("<br>") + "</strong>");
                errorShown = true;
            }
        }
    }
